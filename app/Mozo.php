...
class Mozo extends Model
{
    ...
    //va a tener en cuenta siempre que idrol es primaryKey y la va usar siempre para trabajar con el dato especifico
    ...
    protected $fillable = ['mozo','nombres','apellidos','telefono','estado'];
}
