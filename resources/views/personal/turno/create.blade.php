...
@section ('contenido') <!--abrimos la seccion donde estara nuestro contenido dinamico donde 'contenido' es el que definimos en la plantilla-->
    ...
    {!!Form::open(array('url'=>'personal/turno','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
    <div class="row ml-1 mr-1 p-2 border">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label for="hora_inicio">Hora de Ingreso</label>
                <input type="time" name="hora_inicio" required value="{{old('hora_inicio')}}" class="form-control" placeholder="00:00">
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label for="hora_salida">Hora de Salida</label>
                <input type="time" name="hora_salida" value="{{old('hora_salida')}}" class="form-control" placeholder="00:00">
            </div>
        </div>
