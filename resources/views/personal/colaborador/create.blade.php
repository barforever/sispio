...
@section ('contenido') <!--abrimos la seccion donde estara nuestro contenido dinamico donde 'contenido' es el que definimos en la plantilla-->
    <div class="row ml-1 mr-1 p-2 border bg-light">
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
            <h4>INGRESA NUEVO COLABORADOR</h4>
            @if (count($errors)>0)
    ...
    {!!Form::open(array('url'=>'personal/colaborador','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
    <div class="row ml-1 mr-1 p-2 border">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label for="nickname">NickName</label>
                <input type="text" name="nickname" required value="{{old('nickname')}}" class="form-control" placeholder="Nombre Abreviado...">
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
