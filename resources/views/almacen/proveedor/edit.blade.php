...
@section ('contenido') <!--abrimos la seccion donde estara nuestro contenido dinamico donde 'contenido' es el que definimos en la plantilla-->
    <div class="row ml-1 mr-1 p-2 border bg-light">
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
            <h4>EDITAR PROVEEDOR: <nom>{{ $proveedor->nombre }}</nom></h4>
            @if (count($errors)>0)
    ...
    {!!Form::model($proveedor,['method'=>'PATCH','route'=>['proveedor.update',$proveedor->idpersona]])!!}
    {{Form::token()}}
    <div class="row ml-1 mr-1 p-2 border">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" name="nombre" required value="{{ $proveedor->nombre }}" class="form-control" placeholder="Nombre o Razon Social...">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label><h6>Tipo de Documento</h6></label>
                    <select name="tipo_documento" value=""class="form-control">
                        ...
                        @elseif ($proveedor->tipo_documento=='RUC')
                            ...
                            <option value="PAS">PASAPORTE</option>
                            <option value="C-EXT">C. EXTRANJERIA</option>
                        @elseif ($proveedor->tipo_documento=='PAS')
                            <option value="DNI">DNI</option>
                            <option value="RUC">RUC</option>
                        ...
                        @else
                            ...
                            <option value="RUC">RUC</option>
                            <option value="PAS">PASAPORTE</option>
                            <option value="C-EXT" selected>C. EXTRANJERIA</option>                            
                        @endif
                    </select>  
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="num_documento" value="{{ $proveedor->num_documento }}" class="form-control" placeholder="Numero de Documento...">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="date" name="f_nacimiento" value="{{ $proveedor->f_nacimiento }}" class="form-control" placeholder="Fecha de Nacimiento...">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" name="email" value="{{ $proveedor->email }}" class="form-control" placeholder="Correo Electronico...">
                </div>
            </div>
