    ...
    <div class="row ml-1 mr-1 p-2 border">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="nombre" required value="{{old('nombre')}}" class="form-control" placeholder="Nombre Insumo...">
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <div class="form-group">
                <label for="cantidad">Stock</label>
                <input type="text" name="cantidad" value="{{old('cantidad')}}" class="form-control" placeholder="Cantidad Insumo...">
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <div class="form-group">
                <label for="unidad_medida">Unidad de Medida</label>
                <input type="text" name="unidad_medida" value="{{old('unidad_medida')}}" class="form-control" placeholder="und, kg, lt, etc...">
            </div>
        </div>
