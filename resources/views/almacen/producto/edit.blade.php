...
@section ('contenido') <!--abrimos la seccion donde estara nuestro contenido dinamico donde 'contenido' es el que definimos en la plantilla-->
    <div class="row ml-1 mr-1 p-2 border bg-light">
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
            <h4>EDITAR PRODUCTO: </br><nom>{{ $producto->nombre }}</nom></h4>
            @if (count($errors)>0)
            ...
            <div class="row p-1 border-right">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-primary">        
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" required value="{{$producto->nombre}}" class="form-control" placeholder="Nombre Producto...">
                    </div>
                </div>        
                <!-- div categoria -->              
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-primary">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-primary">        
                    <div class="form-group">
                        ...
                        <input type="text" name="precio" required value="{{$producto->precio}}" class="form-control" placeholder="Precio..">         
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-primary">
                    <div class="form-group">
                        ...
                        <div class="text-center">
                            <img src="{{asset('imagenes/productos/'.$producto->imagen)}}" height="150px" width="250px" class="img-responsive img-thumbnail">
                        </div>
                        @endif
                    </div>
                </div>             
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-3">
                    ...
                    <table id="detalles" class="table table-bordered table-condensed table-hover table-sm">
                        <thead class="text-center text-black" style="background-color: #f8c819">
                            ...
                            @foreach ($insumoproducto as $ip)
                            <tr class="selected" id="fila{{$cont++}}">                                                     
                                <td><button type="button" class="btn btn-danger" onclick="eliminar({{$cont2++}});">x</button></td>
                                <td><input type="hidden" name="idinsumo[]" value="{{$ip->idinsumo}}">{{$ip->nombre}}</td>
                                <td><input type="number" step="any" name="cantidad_utilizada[]" value="{{$ip->cantidad_utilizada}}"></td>
                                <td><input type="text" disabled name="unidad_medida[]" value="{{$ip->unidad_medida}}"></td>
                            </tr>
                            @endforeach
                    </table>
                    </div>            
