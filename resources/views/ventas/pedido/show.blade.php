...
@section ('contenido')
    <div class="row ml-1 mr-1 p-2 border bg-light">
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
            <h4>DETALLE DE PEDIDO DE LA MESA: <act>{{$pedido->num_mesa}}</act></h4>
            @if (count($errors)>0)
            ...
            <div class="row p-1 m-1 border align-items-center">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 border">
                    <div class="form-group">                          
                        ...
                        <h5 class="text-center">PEDIDO N° {{str_pad($pedido->idpedido,5,"0",STR_PAD_LEFT)}}</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row p-1 m-1 border">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group row">
                        <label for="fecha" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 col-form-label font-weight-bold">Fecha de Pedido :</label>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <input type="text" readonly class="form-control-plaintext" id="fecha" value="{{ date('d-m-Y',strtotime($pedido->fecha))}}">
                        </div>
                        <label for="fecha" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 col-form-label font-weight-bold">N° de Comanda :</label>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <input type="text" readonly class="form-control-plaintext" id="fecha" value="{{ $pedido->num_comanda }}">
                        </div>
                        <label for="fecha" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 col-form-label font-weight-bold">Mesa :</label>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <input type="text" readonly class="form-control-plaintext" id="fecha" value="{{ $pedido->num_mesa }}">
                        </div>
                        <label for="fecha" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 col-form-label font-weight-bold">Mozo :</label>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <input type="text" readonly class="form-control-plaintext" id="fecha" value="{{ $pedido->nickname }}">
                        </div>
                    </div>                    
                </div>
            </div>                
