            ...
            <div class="row p-1">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-primary">        
                    <div class="form-group">
                        ...
                        <input type="number" name="tcantidad" id="tcantidad" class="form-control" placeholder="Cantidad">
                        <button type="button" class="btn btn-primary" id="aumentar"><i class="fa fa-plus fa-fw"></i></button>
                        <button type="button" class="btn btn-primary" id="disminuir"><i class="fa fa-minus fa-fw"></i></button>
                    </div>
                </div>
                <!-- div precio_venta --> 
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-primary">        
                    <div class="form-group">
                        <label for="precio_venta"><h6>Precio</h6></label>
                        <input type="number" step="any" disabled name="tprecio_venta" id="tprecio_venta" class="form-control" placeholder="">
                    </div>
                </div>
                <!-- div boton agregar --> 
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-right text-primary">        
                    <div class="form-group text-center">
                        <label for="agregar"><h6>.</h6></label></br>
