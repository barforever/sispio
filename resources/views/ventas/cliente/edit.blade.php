...
@section ('contenido') <!--abrimos la seccion donde estara nuestro contenido dinamico donde 'contenido' es el que definimos en la plantilla-->
    <div class="row ml-1 mr-1 p-2 border bg-light">
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
            <h4>EDITAR CLIENTE: <nom>{{ $cliente->nombre }}</nom></h4>
            @if (count($errors)>0)
    ...
    <div class="row ml-1 mr-1 p-2 border">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" required value="{{ $cliente->nombre }}" class="form-control" placeholder="Nombre o Razon Social...">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="date" name="f_nacimiento" value="{{ $cliente->f_nacimiento }}" class="form-control" placeholder="Fecha de Nacimiento...">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
